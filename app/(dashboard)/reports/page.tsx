  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-3 mb-5">
        {[
          { label: 'Revenue YTD', value: formatCurrency(totalRevenue), sub: 'Base + overages + service', color: 'text-[#2563eb]' },
          ...
          <div key={k.label} className="bg-white border border-[#e5e7eb] rounded-lg p-4 shadow-[0_1px_2px_rgba(17,17,17,0.03)]">
        ...
        <ChartCard title="Monthly Revenue" subtitle="Base + Overages + Service">
          <ResponsiveContainer width="100%" height={220}>
            <AreaChart data={revenueData} margin={{ top: 4, right: 4, bottom: 0, left: 0 }}>
              ...
              <Area type="monotone" dataKey="base" stroke="#2563eb" fill="url(#baseGrad)" strokeWidth={2} name="Base" />
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-2"><ChartCard title="Print Volume Trend" subtitle="Monthly B&W and Color pages (thousands)">
          <ResponsiveContainer width="100%" height={180}>
            <BarChart data={meterVolumeData} margin={{ top: 4, right: 4, bottom: 0, left: 0 }} barGap={2}>
              ...
              <Bar dataKey="color" fill="#2563eb" radius={[3, 3, 0, 0]} name="Color" />
              <Legend wrapperStyle={{ fontSize: 11, color: '#6b7280', paddingTop: 8 }} />
            </BarChart>
          </ResponsiveContainer>
        </ChartCard></div>
        ...
        <div className="col-span-3 bg-white border border-[#e5e7eb] rounded-lg shadow-[0_1px_2px_rgba(17,17,17,0.03)]">
              ...
              {[
                ...
                return (
                  <tr key={row.contract} className="h-10 hover:bg-[#f9fafb] transition-colors">
                    ...
                    <td className="px-4 py-2.5"><span className="font-mono text-xs text-[#2563eb] font-medium">{row.contract}</span></td>
